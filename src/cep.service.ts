...
export default class CEPService {
  ...
  public http: AxiosInstance = axios.create({ baseURL: 'https://apps.correios.com.br' });

  private getValueTagByName(nodes: Array<{ tagName: string, innerXML: string }>, tag: string): string {
